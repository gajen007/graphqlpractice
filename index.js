...
const books = [
    { id:1, name:"Poniyin Selvan", authorID:1},
    { id:2, name: "Sivagamiyin Sabatham", authorID:1},
    { id:3, name: "Paarthipan Kanavu", authorID:1},
    { id:4, name: "Udaiyaar", authorID:2},
    { id:5, name: "Vengaiyin Mainthan", authorID:3},
    { id:6, name: "Kadal Pura", authorID:4},
    { id:7, name: "Jala Theepam", authorID:4},
    { id:8, name: "Yavana Rani", authorID:4}
];

const authors = [
    {id:1,name:"Kalki"},
    {id:2,name:"Balakumaran"},
    {id:3,name:"Akilan"},
    {id:4,name:"Saandilyan"},
]
